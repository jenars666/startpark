...
export default function RootLoginPage() {
  ...
  // Manual email/password submit — checks hardcoded dev credentials
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (match) {
      if (match.role === 'admin') {
        ...
        window.location.href = '/home'; // Redirect to store home
      }
      return;
    }
  ...
  const handleGoogleSignIn = async () => {
    ...
    setError('');
    try {
      await signIn('google', { callbackUrl: '/home' }); // Redirect users to /home after Google login
    } catch {
    ...
    <div className="auth-page">
      ...
      <div className="auth-form-panel">
        <div className="auth-form-container">
          ...
          {/* ⚠️ DEV-ONLY HINT — Remove before deployment */}
          ...
          {/* Google Sign-In — prominently first */}
          <button
            type="button"
          ...
          {/* Email/Password Form (admin only in practice) */}
