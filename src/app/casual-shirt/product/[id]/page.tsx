...
function CasualProductDetailView({ product }: { product: (typeof casualProducts)[number] }) {
  ...
  const featureItems = useMemo(
    () => [
      '100% premium cotton with breathable weave and all-day comfort',
      'Modern casual fit silhouette with soft collar and relaxed structure',
      'Pre-shrunk fabric engineered for everyday wear and weekend outings',
    ],
    []
  );
    ...
    () => [
      {
        ...
        body: `Great casual fit and quality. Comfortable for office casual or weekends.`,
        rating: 5,
        helpful: 24,
      ...
      },
      {
        ...
        date: 'Sep 28, 2023',
        title: 'Nice Quality',
        body: `Soft fabric and true to size. Good value for casual wear.`,
        rating: 4,
        helpful: 12,
        images: [],
        verified: true,
  ...
  const handleShare = async () => {
    const shareUrl = typeof window !== 'undefined' ? window.location.href : `http://localhost:3000/casual-shirt/product/${product.id}`;
    const shareData = {
      title: product.name,
      text: `Check out this casual shirt: ${product.name}`,
      url: shareUrl,
    };
        ...
        <div className="atelier-topbar-inner">
          ...
          <div className="atelier-top-actions">
            <button
              ...
              onClick={() => router.push('/casual-shirt')}
              aria-label="Browse casual shirts"
            >
              <Search size={19} />
            </button>
            <button
      ...
      <main className="atelier-detail-main">
        ...
        <section className="atelier-summary-card">
          <div className="atelier-copy-block">
            <p className="atelier-overline">Casual Collection</p>
            <h1 className="atelier-product-title">{product.name}</h1>
            <p className="atelier-product-subtitle">
              Premium casual shirt for everyday comfort and stylish casual occasions.
            </p>
          </div>
        ...
        <section className="atelier-details-panel">
          ...
          <div className="atelier-accordion-item">
            ...
            {openSection === 'style' && (
              <div className="atelier-accordion-body">
                <p>
                  Pair this casual shirt with chinos, sneakers, and minimal accessories for versatile day-to-night styling.
                </p>
              </div>
            )}
          </div>
        ...
        <section className="atelier-related-section">
          <div className="atelier-section-title-row">
            ...
            <Link href="/casual-shirt" className="atelier-inline-link">
              Browse collection
            </Link>
          </div>
          ...
          <div className="atelier-related-rail no-scrollbar">
            {relatedProducts.map((related) => (
              <Link href={`/casual-shirt/product/${related.id}`} className="atelier-related-card" key={related.id}>
                ...
                <p className="atelier-related-brand">Casual</p>
            ...
            <form className="atelier-review-form" onSubmit={handleReviewSubmit}>
              <div className="atelier-review-form-header">
                <div>
                  ...
                  <p>Share your fit, fabric, and styling feedback for this casual shirt.</p>
                </div>
                <button
                  type="button"
              ...
              <label className="atelier-field">
                ...
                <textarea
                  ...
                  rows={5}
                  placeholder="Tell shoppers about fit, fabric quality, and casual styling."
                />
              </label>
